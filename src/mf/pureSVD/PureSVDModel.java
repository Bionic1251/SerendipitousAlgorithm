 ...
 */
@DefaultProvider(PureSVDModelBuilder.class)
@Shareable
public final class PureSVDModel extends MFModel {
	private static final long serialVersionUID = 3L;

	private final List<FeatureInfo> featureInfo;
	private final AVector averageUser;

	public PureSVDModel(ImmutableMatrix umat, ImmutableMatrix imat,
	...
	public AVector getRandomItemVector() {
		return averageUser;
	}
}
