...
public class WeirdAggregateGenresSerendipityTopNMetric extends AbstractMetric<MeanAccumulator, WeirdAggregateGenresSerendipityTopNMetric.AggregateResult, WeirdAggregateGenresSerendipityTopNMetric.AggregateResult> {
	...
	public WeirdAggregateGenresSerendipityTopNMetric(String suffix, ItemSelector candidates, ItemSelector exclude) {
