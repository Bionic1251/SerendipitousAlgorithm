 ...
 */
public class LuFunkSVDItemScorerBaysian extends AbstractItemScorer {
	private static final Logger logger = LoggerFactory.getLogger(LuFunkSVDItemScorerBaysian.class);
	protected final LuFunkSVDModelBaysian model;
	 ...
	 */
	@Inject
	public LuFunkSVDItemScorerBaysian(UserEventDAO dao, LuFunkSVDModelBaysian model,
