 ...
 */
@Shareable
public final class SPRFunkSVDUpdateRule implements Serializable {
	 ...
	 */
	@Inject
	public SPRFunkSVDUpdateRule(@LearningRate double lrate,
	 ...
	 */
	public SPRTrainingEstimator makeEstimator(PreferenceSnapshot snapshot) {
		return new SPRTrainingEstimator(snapshot, baseline, domain);
	}
	...
	public SPRFunkSVDUpdater createUpdater() {
		return new SPRFunkSVDUpdater(this);
	}
}
