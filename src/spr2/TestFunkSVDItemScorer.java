 ...
 */
public class TestFunkSVDItemScorer extends AbstractItemScorer {
	private static final Logger logger = LoggerFactory.getLogger(TestFunkSVDItemScorer.class);
	protected final TestFunkSVDModel model;
	...
	@Nullable
	private final TestFunkSVDUpdateRule rule;
	 ...
	 */
	@Inject
	public TestFunkSVDItemScorer(UserEventDAO dao, TestFunkSVDModel model,
								 @BaselineScorer ItemScorer baseline,
								 @Nullable PreferenceDomain dom,
								 @Nullable @RuntimeUpdate TestFunkSVDUpdateRule rule) {
	...
	@Nullable
	public TestFunkSVDUpdateRule getUpdateRule() {
		return rule;
	}
	...
	private double doFeatureIteration(long user, AVector uprefs,
		...
		TestFunkSVDUpdater updater = rule.createUpdater();
