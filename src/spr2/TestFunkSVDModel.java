 ...
 */
@DefaultProvider(TestFunkSVDModelBuilder.class)
@Shareable
public final class TestFunkSVDModel extends MFModel {
	private static final long serialVersionUID = 3L;

	private final List<FeatureInfo> featureInfo;
	private final AVector averageUser;

	public TestFunkSVDModel(ImmutableMatrix umat, ImmutableMatrix imat,
