 ...
 */
@Shareable
public final class TestFunkSVDUpdateRule implements Serializable {
	 ...
	 */
	@Inject
	public TestFunkSVDUpdateRule(@LearningRate double lrate,
	 ...
	 */
	public TestTrainingEstimator makeEstimator(PreferenceSnapshot snapshot) {
		return new TestTrainingEstimator(snapshot, baseline, domain);
	}
	...
	public TestFunkSVDUpdater createUpdater() {
		return new TestFunkSVDUpdater(this);
	}
}
